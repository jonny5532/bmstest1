...
void kalman_update(int32_t current_mA, int32_t voltage_mV, int32_t dt_ms) {
    ...
    float soc_prediction = soc_estimate - ((current_A * dt_s) / capacity);
